...
const CHECKBOX_FIELD_MAPPING = {
  ...
  'personalDetails.title.MR': 'Check Box8',
  'personalDetails.title.MRS': 'Check Box9',
  'personalDetails.title.MS': 'Check Box10',
  'personalDetails.title.MISS': 'Check Box11',
  'personalDetails.title.DR': 'Check Box12',
  'personalDetails.title.OTHER': 'Check Box13',
  
  // Spouse title checkboxes (Check Box3.0-3.5)
  'spouseDetails.title.MR': 'Check Box3.0',
  'spouseDetails.title.MRS': 'Check Box3.1',
  'spouseDetails.title.MS': 'Check Box3.2',
  'spouseDetails.title.MISS': 'Check Box3.3',
  'spouseDetails.title.DR': 'Check Box3.4',
  'spouseDetails.title.OTHER': 'Check Box3.5',
  
  // Phone selection checkboxes
  'contactInfo.selectedPhones.mobile': 'Check Box4.0',
  'contactInfo.selectedPhones.home': 'Check Box4.1', 
  'contactInfo.selectedPhones.work': 'Check Box4.2',
  
  'spouseDetails.selectedPhones.mobile': 'Check Box4.3',
  'spouseDetails.selectedPhones.home': 'Check Box4.4',
  'spouseDetails.selectedPhones.work': 'Check Box4.5',
  ...
  // 'additionalInfo.consentGiven': 'Check Box9'
};
